...
def main():
    ...
    parser.add_argument('--precomputed', type=str, default='/home/qkrwnstj/Style-Transfer/precomputed_feats_k')
    ...
    parser.add_argument('--data_root', type=str, default='/home/qkrwnstj/ION-LAB/ablation/single')
    parser.add_argument('--meta_file', type=str, default='/home/qkrwnstj/ION-LAB/ablation/single/_dataset.txt', help='run_ori.py 전용 메타 파일 (content + N style 토큰)')
